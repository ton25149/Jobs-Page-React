    ...
    <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center ">
      ...
      <div className="grid">
        ...
        <div className="grid gap-3">
          ...
          <li className="text-white    hover:opacity-[1] ">Account</li>
          <li className="text-white    hover:opacity-[1] ">Support Center</li>
          <li className="text-white    hover:opacity-[1] ">Feedback</li>
          <li className="text-white    hover:opacity-[1] ">Contract</li>
      ...
      <div className="grid">
        ...
        <div className="grid gap-3">
          ...
          <li className="text-white    hover:opacity-[1] ">Events</li>
          <li className="text-white    hover:opacity-[1] ">Promo</li>
          <li className="text-white    hover:opacity-[1] ">Req Demo</li>
          <li className="text-white    hover:opacity-[1] ">Careers</li>
      ...
      <div className="grid">
        ...
        <div>
          <small className="text-[14px] text-white">patsawee_web@hotmail.com</small>
